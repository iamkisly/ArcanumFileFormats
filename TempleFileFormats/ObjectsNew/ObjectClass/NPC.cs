...
namespace ArcanumFileFormats.ObjectsNew
{
    public partial class NPC : Critter
    {
		...
		[Order(77)] public Location[] obj_f_npc_waypoints_idx {get; set;}
		...
		[Order(87)] public Int32[] obj_f_npc_reaction_pc_idx {get; set;}
		[Order(88)] public Int32[] obj_f_npc_reaction_level_idx {get; set;}
		[Order(89)] public Int32[] obj_f_npc_reaction_time_idx {get; set;}
		...
		[Order(93)] public Int32[] obj_f_npc_damage_idx {get; set;}
		[Order(94)] public Int32[] obj_f_npc_shit_list_idx {get; set;}
    }
}