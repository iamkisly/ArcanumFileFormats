...
namespace ArcanumFileFormats.ObjectsNew
{
	public partial class Critter : Common
    {
		...
		[Order(39)] public Int32[] obj_f_critter_stat_base_idx {get; set;}
		[Order(40)] public Int32[] obj_f_critter_basic_skill_idx {get; set;}
		[Order(41)] public Int32[] obj_f_critter_tech_skill_idx {get; set;}
		[Order(42)] public Int32[] obj_f_critter_spell_tech_idx {get; set;}
		...
		[Order(47)] public Int32[] obj_f_critter_effects_idx {get; set;}
		[Order(48)] public Int32[] obj_f_critter_effect_cause_idx {get; set;}
		...
		[Order(57)] public ObjectGuid[] obj_f_critter_inventory_list_idx {get; set;}
		...
		[Order(60)] public ObjectGuid[] obj_f_critter_follower_idx {get; set;}
