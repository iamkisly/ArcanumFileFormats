...
namespace ArcanumFileFormats.ObjectsNew
{
    public class PC : Critter
    {
		...
		[Order(72)]public Int32[] obj_f_pc_reputation_idx {get; set;}
		[Order(73)]public Int32[] obj_f_pc_reputation_ts_idx {get; set;}
		[Order(74)]public Int32 obj_f_pc_background {get; set;}
		[Order(75)]public Int32 obj_f_pc_background_text {get; set;}
		[Order(76)]public Int32[] obj_f_pc_quest_idx {get; set;}
		[Order(77)]public Int32[] obj_f_pc_blessing_idx {get; set;}
		[Order(78)]public Int32[] obj_f_pc_blessing_ts_idx {get; set;}
		[Order(79)]public Int32[] obj_f_pc_curse_idx {get; set;}
		[Order(80)]public Int32[] obj_f_pc_curse_ts_idx {get; set;}
		[Order(81)]public Int32 obj_f_pc_party_id {get; set;}
		[Order(82)]public Int32[] obj_f_pc_rumor_idx {get; set;}
		[Order(83)]public Unknown obj_f_pc_pad_ias_2 {get; set;}
		[Order(84)]public Int32[] obj_f_pc_schematics_found_idx {get; set;}
		[Order(85)]public Int32[] obj_f_pc_logbook_ego_idx {get; set;}
		...
		[Order(89)]public Int32[] obj_f_pc_global_flags {get; set;}
		[Order(90)]public Int32[] obj_f_pc_global_variables {get; set;}
